...
한글이 주로 사용되는 사이트들 중, 접속 통계 상위권 사이트들과 개인적으로 자주 방문하는 곳들을 돌아다니며, 그들이 본문에 사용하고 있는 CSS 값들에 대해 정리해보았다.
...
우선 `Noto Sans Light`와 같은 획이 가는 서체를 본문 기본 서체로 사용하고 있고, 글씨 크기도 `11pt`로 작은데다,
